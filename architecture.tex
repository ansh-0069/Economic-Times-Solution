...
\title{\vspace{-1.5cm}\Huge \textbf{FinMentor AI \& ArthaScan} \\ \Large A Unified Architecture for Zero-Hallucination Financial Advice}
...
\maketitle
\vspace{-1.25em} % Slightly softer push upwards for better breathing room
